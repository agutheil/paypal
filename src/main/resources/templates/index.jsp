...
<%@ include file="header.jsp" %> 
            ...
            <form class="form" action="Checkout" method="POST">
               <div class="row-fluid">
                  ...
                  <div class="span6 inner-span">
                        ...
                        <tr><td>Tax:</td><td><input type="text" name="PAYMENTREQUEST_0_TAXAMT" value="2.00" readonly></input></td></tr>
                        <tr><td>Shipping Amount:</td><td><input type="text" name="PAYMENTREQUEST_0_SHIPPINGAMT" value="5.00" readonly></input></td></tr>
                        <tr><td>Handling Amount:</td><td><input type="text" name="PAYMENTREQUEST_0_HANDLINGAMT" value="1.00" readonly></input></td></tr>
                        <tr><td>Shipping Discount:</td><td><input type="text" name="PAYMENTREQUEST_0_SHIPDISCAMT" value="-3.00" readonly></input></td></tr>
                        <tr><td>Insurance Amount:</td><td><input type="text" name="PAYMENTREQUEST_0_INSURANCEAMT" value="2.00" readonly></input></td></tr>
                        <tr><td>Total Amount:</td><td><input type="text" name="PAYMENTREQUEST_0_AMT" value="17.00" readonly></input></td></tr>
                        <tr><td>
                        <%
						...
						<tr><td> -- OR -- </td></tr>
						<tr><td ><input type="Submit" alt="Proceed to Check out" class="btn btn-primary btn-large" value="Proceed to Check out" name="checkout"/></td></tr>
                        </table>
                  </div>
               </div>
            </form>
      ...
      <div class="row-fluid">
         <div class="span12 inner-span">
               ...
               <p>
                  ...
                  <br>
                  4) The sample code uses default sandbox credentials which are set in config/config.properties. You can create your own credentials by creating PayPal Seller and Buyer accounts on Sandbox  <i><a href="https://developer.paypal.com/webapps/developer/applications/accounts/create" target="_blank">here</a></i>.
   ...
   <pre><code>&lt;form action="Checkout" method="POST"&gt;
      ...
      <i>&lt;!--Pass additional input parameters based on your shopping cart. For complete list of all the parameters <a href="https://developer.paypal.com/docs/classic/api/merchant/DoDirectPayment_API_Operation_NVP/" target=_blank>click here</a></i> --&gt;
...
&lt;/form&gt;</code></pre>
 3) In  config/config.properties, uncomment the 'Express Checkout URLs for Sandbox' and comment out the 'In-Context in Express Checkout URLs for Sandbox'.
