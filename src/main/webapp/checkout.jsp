...
<%@ include file="header.jsp" %>
   ...
   <div class="span5">
            ...
            <input type="hidden" name="L_PAYMENTREQUEST_0_AMT" value="<c:out value="${fn:escapeXml(PAYMENTREQUEST_0_AMT)}" />" >
               <div class="row-fluid">
                  <div class="span6 inner-span">
                        ...
                        <tr><td>Country</td><td>
							<select id="PAYMENTREQUEST_0_SHIPTOZIP" name="PAYMENTREQUEST_0_SHIPTOCOUNTRY">
					...
					<tr><td colspan="2">
						<input checked id="paypal_payment_option" value="paypal_express" type="radio" name="payment_method" title="PayPal Express Check out" class="radio" >
					...
					<input readonly="" disabled id="p_method_paypal_express"  value="credit_card" type="radio"  name="payment_method" title="PayPal Express Check out" class="radio" >&nbsp;Credit Card</td>
					<td>
					</td>
					</tr>
					    </table>
